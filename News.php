...
<?php
 ...
 $qz = mysqli_query($dz,"SELECT * FROM latest ORDER BY id DESC");
 $i = 0;
...
?>
<p align="center" style="text-shadow:gray 2px 2px 1px"><font face="candara" size="6" color="maroon"><b>News Headlines</b></font></p>
<?php echo $dtable; ?>
</form>
</div>
</div>
