...
<?php
 ...
 $qz = mysqli_query($dz,"SELECT * FROM local ORDER BY id DESC");
 $i = 0;
...
<p align="center" style="text-shadow:gray 2px 2px 1px"><font face="candara" size="6" color="maroon"><b>Local News</b></font></p>
<?php echo $dtable; ?>
</form>
</div>
</div>
