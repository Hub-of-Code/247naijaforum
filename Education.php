...
<?php
 ...
 $qz = mysqli_query($dz,"SELECT * FROM education ORDER BY id DESC");
 $i = 0;
...
<p align="center" style="text-shadow:gray 2px 2px 1px"><font face="candara" size="6" color="maroon"><b>Education News</b></font></p>
<?php echo $dtable; ?>
</form>
</div>
</div>
